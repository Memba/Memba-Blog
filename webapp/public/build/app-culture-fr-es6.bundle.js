...
(self["webpackChunkMemba_Blog"] = self["webpackChunkMemba_Blog"] || []).push([["app-culture-fr-es6"],{
...
if (window.kendo && window.kendo.ui) {
  ...
  var _window$kendo = window.kendo,
      ...
      AudioVideo = _window$kendo$ui.AudioVideo,
  ...
  if (AudioVideo) {
    var _options = AudioVideo.prototype.options;
  ...
  if (BaseDialog) {
    var _options2 = BaseDialog.prototype.options;
  ...
  if (BasicList) {
    var _options3 = BasicList.prototype.options;
  ...
  if (CodeEditor) {
    var _options4 = CodeEditor.prototype.options;
  ...
  if (Explorer) {
    var _options5 = Explorer.prototype.options;
  ...
  if (ImageList) {
    var _options6 = ImageList.prototype.options;
  ...
  if (MarkEditor) {
    var _options7 = MarkEditor.prototype.options;
  ...
  if (StyleEditor) {
    ...
    _options16.messages = jquery__WEBPACK_IMPORTED_MODULE_0___default().extend(true, _options16.messages, {
      columns: {
        name: 'Nom',
        value: 'Valeur'
      },
