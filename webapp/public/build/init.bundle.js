...
/*!
         ...
         !*/
i.addTest("hashchange",function(){return!1!==p("hashchange",e)&&(t.documentMode===n||t.documentMode>7)});var v,m,g=a._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):["",""];function w(e,t){if("object"==typeof e)for(var n in e)v(e,n)&&w(n,e[n]);else{var o=(e=e.toLowerCase()).split("."),r=i[o[0]];if(2===o.length&&(r=r[o[1]]),void 0!==r)return i;t="function"==typeof t?t():t,1===o.length?i[o[0]]=t:(!i[o[0]]||i[o[0]]instanceof Boolean||(i[o[0]]=new Boolean(i[o[0]])),i[o[0]][o[1]]=t),u([(t&&!1!==t?"":"no-")+o.join("-")]),i._trigger(e,t)}return i}function h(e){return e.replace(/([a-z])-([a-z])/g,function(e,t,n){return t+n.toUpperCase()}).replace(/^-/,"")}function y(e,n,o,r){var a,i,s,u,f="modernizr",p=d("div"),v=function(){var e=t.body;return e||((e=d(l?"svg":"body")).fake=!0),e}();if(parseInt(o,10))for(;o--;)(s=d("div")).id=r?r[o]:f+(o+1),p.appendChild(s);return(a=d("style")).type="text/css",a.id="s"+f,(v.fake?v:p).appendChild(a),v.appendChild(p),a.styleSheet?a.styleSheet.cssText=e:a.appendChild(t.createTextNode(e)),p.id=f,v.fake&&(v.style.background="",v.style.overflow="hidden",u=c.style.overflow,c.style.overflow="hidden",c.appendChild(v)),i=n(p,e),v.fake?(v.parentNode.removeChild(v),c.style.overflow=u,c.offsetHeight):p.parentNode.removeChild(p),!!i}a._prefixes=g,v=s(m={}.hasOwnProperty,"undefined")||s(m.call,"undefined")?function(e,t){return t in e&&s(e.constructor.prototype[t],"undefined")}:function(e,t){return m.call(e,t)},a._l={},a.on=function(e,t){this._l[e]||(this._l[e]=[]),this._l[e].push(t),i.hasOwnProperty(e)&&setTimeout(function(){i._trigger(e,i[e])},0)},a._trigger=function(e,t){if(this._l[e]){var n=this._l[e];setTimeout(function(){var e;for(e=0;e<n.length;e++)(0,n[e])(t)},0),delete this._l[e]}},i._q.push(function(){a.addTest=w}),
/*!
         {
...
/*!
         ...
         !*/
i.addAsyncTest(function(){-1!==navigator.userAgent.indexOf("MSIE 7.")&&setTimeout(function(){w("datauri",!1)},10);var e=new Image;e.onerror=function(){w("datauri",!1)},e.onload=function(){1===e.width&&1===e.height?w("datauri",!0):w("datauri",!1)},e.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="});var b=a.testStyles=y;
/*!
         {
         "name": "Touch Events",
         ...
         !*/i.addTest("touchevents",function(){var n;if("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)n=!0;else{var o=["@media (",g.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");b(o,function(e){n=9===e.offsetTop})}return n});var x=a._config.usePrefixes?"Moz O ms Webkit".split(" "):[];a._cssomPrefixes=x;var T=function(t){var o,r=g.length,a=e.CSSRule;if(void 0===a)return n;if(!t)return!1;if((o=(t=t.replace(/^@/,"")).replace(/-/g,"_").toUpperCase()+"_RULE")in a)return"@"+t;for(var i=0;i<r;i++){var s=g[i];if(s.toUpperCase()+"_"+o in a)return"@-"+s.toLowerCase()+"-"+t}return!1};a.atRule=T;var A=a._config.usePrefixes?"Moz O ms Webkit".toLowerCase().split(" "):[];function S(e,t){return function(){return e.apply(t,arguments)}}a._domPrefixes=A;var C={elem:d("modernizr")};i._q.push(function(){delete C.elem});var P={style:C.elem.style};function _(e){return e.replace(/([A-Z])/g,function(e,t){return"-"+t.toLowerCase()}).replace(/^ms-/,"-ms-")}function E(t,o){var r=t.length;if("CSS"in e&&"supports"in e.CSS){for(;r--;)if(e.CSS.supports(_(t[r]),o))return!0;return!1}if("CSSSupportsRule"in e){for(var a=[];r--;)a.push("("+_(t[r])+":"+o+")");return y("@supports ("+(a=a.join(" or "))+") { #modernizr { position: absolute; } }",function(t){return"absolute"===function(t,n,o){var r;if("getComputedStyle"in e){r=getComputedStyle.call(e,t,n);var a=e.console;null!==r?o&&(r=r.getPropertyValue(o)):a&&a[a.error?"error":"log"].call(a,"getComputedStyle returning null, its possible modernizr test results are inaccurate")}else r=!n&&t.currentStyle&&t.currentStyle[o];return r}(t,null,"position")})}return n}function O(e,t,o,r,a){var i=e.charAt(0).toUpperCase()+e.slice(1),c=(e+" "+x.join(i+" ")+i).split(" ");return s(t,"string")||s(t,"undefined")?function(e,t,o,r){if(r=!s(r,"undefined")&&r,!s(o,"undefined")){var a=E(e,o);if(!s(a,"undefined"))return a}for(var i,c,l,u,f,p=["modernizr","tspan","samp"];!P.style&&p.length;)i=!0,P.modElem=d(p.shift()),P.style=P.modElem.style;function v(){i&&(delete P.style,delete P.modElem)}for(l=e.length,c=0;c<l;c++)if(u=e[c],f=P.style[u],~(""+u).indexOf("-")&&(u=h(u)),P.style[u]!==n){if(r||s(o,"undefined"))return v(),"pfx"!==t||u;try{P.style[u]=o}catch(e){}if(P.style[u]!==f)return v(),"pfx"!==t||u}return v(),!1}(c,t,r,a):function(e,t,n){var o;for(var r in e)if(e[r]in t)return!1===n?e[r]:s(o=t[e[r]],"function")?S(o,n||t):o;return!1}(c=(e+" "+A.join(i+" ")+i).split(" "),t,o)}function j(e,t,o){return O(e,n,n,t,o)}i._q.unshift(function(){delete P.style}),a.testAllProps=O,a.testAllProps=j,
/*!
         {
         "name": "Flexbox",
         "property": "flexbox",
...
/*!
         ...
         !*/
i.addTest("csstransforms",function(){return-1===navigator.userAgent.indexOf("Android 2.")&&j("transform","scale(1)",!0)});var L=(a.prefixed=function(e,t,n){return 0===e.indexOf("@")?T(e):(-1!==e.indexOf("-")&&(e=h(e)),t?O(e,t,n):O(e,"pfx"))})("URL",e,!1);
/*!
         {
         "name": "Blob URLs",
         "property": "bloburls",
