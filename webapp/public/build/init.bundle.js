...
x.addTest("flexbox",h("flexBasis","1px",!0)),/*!
	         ...
	         !*/
x.addTest("csstransforms",function(){return navigator.userAgent.indexOf("Android 2.")===-1&&h("transform","scale(1)",!0)});var z=A.prefixed=function(e,t,n){return 0===e.indexOf("@")?k(e):(e.indexOf("-")!==-1&&(e=c(e)),t?w(e,t,n):w(e,"pfx"))},$=z("URL",e,!1);$=$&&e[$],x.addTest("bloburls",$&&"revokeObjectURL"in $&&"createObjectURL"in $),r(),a(y),delete A.addTest,delete A.addAsyncTest;for(var I=0;I<x._q.length;I++)x._q[I]();e.Modernizr=x}(window,document),e.support=window.Modernizr,window.app},n(185))}});
