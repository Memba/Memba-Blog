...
x.addTest("canvas",function(){var e=i("canvas");return!(!e.getContext||!e.getContext("2d"))}),/*!
	         ...
	         !*/
x.addTest("canvastext",function(){return x.canvas===!1?!1:"function"==typeof i("canvas").getContext("2d").fillText}),/*!
	         {
	             "name": "HTML5 Video",
	             "property": "video",
	             "caniuse": "video",
...
x.addTest("svgasimg",t.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image","1.1")),/*!
	         ...
	         !*/
x.addAsyncTest(function(){function e(){var e=new Image;e.onerror=function(){s("datauri",!0),x.datauri=new Boolean(!0),x.datauri.over32kb=!1},e.onload=function(){s("datauri",!0),x.datauri=new Boolean(!0),x.datauri.over32kb=1===e.width&&1===e.height};for(var t="R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";t.length<33e3;)t="\r\n"+t;e.src="data:image/gif;base64,"+t}-1!==navigator.userAgent.indexOf("MSIE 7.")&&setTimeout(function(){s("datauri",!1)},10);var t=new Image;t.onerror=function(){s("datauri",!1)},t.onload=function(){1===t.width&&1===t.height?e():s("datauri",!1)},t.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="});var j=A.testStyles=l;/*!
	         {
	             "name": "Touch Events",
	         ...
	         !*/
x.addTest("touchevents",function(){var n;if("ontouchstart"in e||e.DocumentTouch&&t instanceof e.DocumentTouch)n=!0;else{var o=["@media (",S.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");j(o,function(e){n=9===e.offsetTop})}return n});var O="Moz O ms Webkit",E=A._config.usePrefixes?O.split(" "):[];A._cssomPrefixes=E;var L=function(t){var o,r=S.length,a=e.CSSRule;if("undefined"==typeof a)return n;if(!t)return!1;if(t=t.replace(/^@/,""),o=t.replace(/-/g,"_").toUpperCase()+"_RULE",o in a)return"@"+t;for(var i=0;r>i;i++){var s=S[i],c=s.toUpperCase()+"_"+o;if(c in a)return"@-"+s.toLowerCase()+"-"+t}return!1};A.atRule=L;var R=A._config.usePrefixes?O.toLowerCase().split(" "):[];A._domPrefixes=R;var k={elem:i("modernizr")};x._q.push(function(){delete k.elem});var z={style:k.elem.style};x._q.unshift(function(){delete z.style}),A.testAllProps=h,A.testAllProps=w,/*!
	         {
	             "name": "Flexbox",
	             "property": "flexbox",
	             "caniuse": "flexbox",
...
x.addTest("flexbox",w("flexBasis","1px",!0)),/*!
	         ...
	         !*/
x.addTest("csstransforms",function(){return-1===navigator.userAgent.indexOf("Android 2.")&&w("transform","scale(1)",!0)});var B=A.prefixed=function(e,t,n){return 0===e.indexOf("@")?L(e):(-1!==e.indexOf("-")&&(e=c(e)),t?h(e,t,n):h(e,"pfx"))},$=B("URL",e,!1);$=$&&e[$],x.addTest("bloburls",$&&"revokeObjectURL"in $&&"createObjectURL"in $),r(),a(y),delete A.addTest,delete A.addAsyncTest;for(var I=0;I<x._q.length;I++)x._q[I]();e.Modernizr=x}(window,document),e.support=window.Modernizr,window.app},n(185))}});
