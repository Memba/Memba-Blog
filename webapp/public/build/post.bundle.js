/*! Copyright ©2013-2019 Memba® Sarl. All rights reserved. - Version 0.3.8 dated 24-Jan-2021 */
...
/* harmony import */ var _vendor_kendo_kendo_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../vendor/kendo/kendo.core */ "./src/js/vendor/kendo/kendo.core.js");
/* harmony import */ var _vendor_kendo_kendo_core__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_kendo_kendo_core__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _app_app_config_jsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../app/app.config.jsx */ "./src/js/app/app.config.jsx");
/* harmony import */ var _app_app_controller_es6__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../app/app.controller.es6 */ "./src/js/app/app.controller.es6");
/* harmony import */ var _app_app_i18n_es6__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../app/app.i18n.es6 */ "./src/js/app/app.i18n.es6");
/* harmony import */ var _common_window_assert_es6__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../common/window.assert.es6 */ "./src/js/common/window.assert.es6");
/* harmony import */ var _common_window_constants_es6__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../common/window.constants.es6 */ "./src/js/common/window.constants.es6");
/* harmony import */ var _common_window_logger_es6__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../common/window.logger.es6 */ "./src/js/common/window.logger.es6");
...
var logger = new _common_window_logger_es6__WEBPACK_IMPORTED_MODULE_8__.default('page.post');
var SELECTORS = {
  SOCIAL: '.app-social'
};
var COMMAND = {
...
var Controller = _app_app_controller_es6__WEBPACK_IMPORTED_MODULE_4__.default.extend({
  /**
   * init
   * @constructor init
   */
  init: function init() {
    ...
    _app_app_controller_es6__WEBPACK_IMPORTED_MODULE_4__.default.fn.init.call(this); // Wait until document is ready to initialize UI
    ...
    this.ready().then(function () {
      ...
      logger.info({
        message: "post page initialized in ".concat(_app_app_i18n_es6__WEBPACK_IMPORTED_MODULE_5__.default.locale),
        method: 'init'
      });
    });
  },
  ...
  initSocialButtons: function initSocialButtons() {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(SELECTORS.SOCIAL).on(_common_window_constants_es6__WEBPACK_IMPORTED_MODULE_7__.default.CLICK, function (e) {
      var _context, _context2, _context3, _context4, _context5, _context6, _context7, _context8, _context9, _context10;

      _common_window_assert_es6__WEBPACK_IMPORTED_MODULE_6__.default.instanceof((jquery__WEBPACK_IMPORTED_MODULE_1___default().Event), e, _common_window_assert_es6__WEBPACK_IMPORTED_MODULE_6__.default.format(_common_window_assert_es6__WEBPACK_IMPORTED_MODULE_6__.default.messages.instanceof.default, 'e', 'default'));
      _common_window_assert_es6__WEBPACK_IMPORTED_MODULE_6__.default.instanceof(HTMLAnchorElement, e.currentTarget, _common_window_assert_es6__WEBPACK_IMPORTED_MODULE_6__.default.format(_common_window_assert_es6__WEBPACK_IMPORTED_MODULE_6__.default.messages.instanceof.default, 'e.currentTarget', 'HTMLAnchorElement'));
      var sharedUrl = encodeURIComponent(jquery__WEBPACK_IMPORTED_MODULE_1___default()('meta[property="og:url"]').attr('content'));
      var source = encodeURIComponent(jquery__WEBPACK_IMPORTED_MODULE_1___default()('meta[property="og:site_name"]').attr('content'));
      var title = encodeURIComponent(jquery__WEBPACK_IMPORTED_MODULE_1___default()('meta[property="og:title"]').attr('content'));
      var description = encodeURIComponent(jquery__WEBPACK_IMPORTED_MODULE_1___default()('meta[property="og:description"]').attr('content'));
      var image = encodeURIComponent(jquery__WEBPACK_IMPORTED_MODULE_1___default()('meta[property="og:image"]').attr('content'));
      var command = jquery__WEBPACK_IMPORTED_MODULE_1___default()(e.currentTarget).attr(attr('command'));
      var openUrl;
      ...
      switch (command) {
        case COMMAND.FACEBOOK:
          ...
          openUrl = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context2 = "https://www.facebook.com/dialog/share?display=popup&app_id=".concat(_app_app_config_jsx__WEBPACK_IMPORTED_MODULE_3__.default.constants.facebookAppId, "&href=")).call(_context2, sharedUrl, "&redirect_uri=")).call(_context, sharedUrl); // openUrl = 'https://www.facebook.com/sharer/sharer.php?u=' + sharedUrl;

          break;

        case COMMAND.GOOGLE:
          // @see https://developers.google.com/+/web/share/
          openUrl = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context3 = "https://plus.google.com/share?url=".concat(sharedUrl, "&hl=")).call(_context3, _app_app_i18n_es6__WEBPACK_IMPORTED_MODULE_5__.default.locale);
          break;

        case COMMAND.LINKEDIN:
          // @see https://developer.linkedin.com/docs/share-on-linkedin
          // Note Linkedin uses open graph meta tags
          openUrl = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context4 = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context5 = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context6 = "https://www.linkedin.com/shareArticle?mini=true&source=".concat(source, "&summary=")).call(_context6, description, "&title=")).call(_context5, title, "&url=")).call(_context4, sharedUrl);
          break;

        case COMMAND.PINTEREST:
          // @see https://developers.pinterest.com/docs/widgets/pin-it/
          openUrl = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context7 = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context8 = "https://pinterest.com/pin/create/button/?url=".concat(sharedUrl, "&media=")).call(_context8, image, "&description=")).call(_context7, description);
          break;

        case COMMAND.TWITTER:
          // Twitter web intent
          // @ see https://dev.twitter.com/web/tweet-button/web-intent
          openUrl = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context9 = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context10 = "https://twitter.com/intent/tweet?text=".concat(title, "&url=")).call(_context10, sharedUrl, "&via=")).call(_context9, _app_app_config_jsx__WEBPACK_IMPORTED_MODULE_3__.default.constants.twitterAccount); // TODO: hashtags (message size limit)?
      ...
      if (socialWindow && jquery__WEBPACK_IMPORTED_MODULE_1___default().isFunction(socialWindow.focus)) {
...
/*!*************************************************************************************************!*\
  !*** ./src/js/cultures/ lazy ^\.\/app\.culture\..*\.es6$ chunkName: [request] namespace object ***!
  \*************************************************************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
/******/ 			return "" + chunkId + ".bundle.js?v=0.3.8";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "Memba.Blog:";
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/js/ui/post.page.es6","common"]
/******/ 		];
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkMemba_Blog"] = self["webpackChunkMemba_Blog"] || [];
