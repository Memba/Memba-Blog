...
return function(e,t,n){function r(e,t){return typeof e===t}function o(){var e,t,n,o,i,a,s;for(var c in m){if(e=[],t=m[c],t.name&&(e.push(t.name.toLowerCase()),t.options&&t.options.aliases&&t.options.aliases.length))for(n=0;n<t.options.aliases.length;n++)e.push(t.options.aliases[n].toLowerCase());for(o=r(t.fn,"function")?t.fn():t.fn,i=0;i<e.length;i++)a=e[i],s=a.split("."),1===s.length?y[s[0]]=o:(!y[s[0]]||y[s[0]]instanceof Boolean||(y[s[0]]=new Boolean(y[s[0]])),y[s[0]][s[1]]=o),w.push((o?"":"no-")+s.join("-"))}}function i(e,t){return!!~(""+e).indexOf(t)}function a(e){return e.replace(/([a-z])-([a-z])/g,function(e,t,n){return t+n.toUpperCase()}).replace(/^-/,"")}function s(e,t){return function(){return e.apply(t,arguments)}}function c(e,t,n){var o;for(var i in e)if(e[i]in t)return n===!1?e[i]:(o=t[e[i]],r(o,"function")?s(o,n||t):o);return!1}function u(e){return e.replace(/([A-Z])/g,function(e,t){return"-"+t.toLowerCase()}).replace(/^ms-/,"-ms-")}function l(){var e=t.body;return e||(e=E("body"),e.fake=!0),e}function f(e,t,n,r){var o,i,a,s,c="modernizr",u=E("div"),f=l();if(parseInt(n,10))for(;n--;)a=E("div"),a.id=r?r[n]:c+(n+1),u.appendChild(a);return o=["&#173;",'<style id="s',c,'">',e,"</style>"].join(""),u.id=c,(f.fake?f:u).innerHTML+=o,f.appendChild(u),f.fake&&(f.style.background="",f.style.overflow="hidden",s=N.style.overflow,N.style.overflow="hidden",N.appendChild(f)),i=t(u,e),f.fake?(f.parentNode.removeChild(f),N.style.overflow=s,N.offsetHeight):u.parentNode.removeChild(u),!!i}function p(t,r){var o=t.length;if("CSS"in e&&"supports"in e.CSS){for(;o--;)if(e.CSS.supports(u(t[o]),r))return!0;return!1}if("CSSSupportsRule"in e){for(var i=[];o--;)i.push("("+u(t[o])+":"+r+")");return i=i.join(" or "),f("@supports ("+i+") { #modernizr { position: absolute; } }",function(e){return"absolute"==getComputedStyle(e,null).position})}return n}function d(e,t,o,s){function c(){l&&(delete O.style,delete O.modElem)}if(s=r(s,"undefined")?!1:s,!r(o,"undefined")){var u=p(e,o);if(!r(u,"undefined"))return u}var l,f,d,g,v;for(O.style||(l=!0,O.modElem=E("modernizr"),O.style=O.modElem.style),d=e.length,f=0;d>f;f++)if(g=e[f],v=O.style[g],i(g,"-")&&(g=a(g)),O.style[g]!==n){if(s||r(o,"undefined"))return c(),"pfx"==t?g:!0;try{O.style[g]=o}catch(m){}if(O.style[g]!=v)return c(),"pfx"==t?g:!0}return c(),!1}function g(e,t,n,o,i){var a=e.charAt(0).toUpperCase()+e.slice(1),s=(e+" "+T.join(a+" ")+a).split(" ");return r(t,"string")||r(t,"undefined")?d(s,t,o,i):(s=(e+" "+A.join(a+" ")+a).split(" "),c(s,t,n))}function v(e,t,r){return g(e,n,n,t,r)}var m=[],h={_version:"3.0.0-alpha.3",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,t){var n=this;setTimeout(function(){t(n[e])},0)},addTest:function(e,t,n){m.push({name:e,fn:t,options:n})},addAsyncTest:function(e){m.push({name:null,fn:e})}},y=function(){};y.prototype=h,y=new y,y.addTest("localstorage",function(){var e="modernizr";try{return localStorage.setItem(e,e),localStorage.removeItem(e),!0}catch(t){return!1}}),y.addTest("sessionstorage",function(){var e="modernizr";try{return sessionStorage.setItem(e,e),sessionStorage.removeItem(e),!0}catch(t){return!1}}),y.addTest("svg",!!t.createElementNS&&!!t.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect);var w=[],E=function(){return"function"!=typeof t.createElement?t.createElement(arguments[0]):t.createElement.apply(t,arguments)};/*!
	         ...
	         !*/
y.addTest("canvas",function(){var e=E("canvas");return!(!e.getContext||!e.getContext("2d"))}),/*!
	         {
	         "name": "Drag & Drop",
	         ...
	         !*/
y.addTest("draganddrop",function(){var e=E("div");return"draggable"in e||"ondragstart"in e&&"ondrop"in e}),/*!
	         {
...
y.addTest("audio",function(){var e=E("audio"),t=!1;try{(t=!!e.canPlayType)&&(t=new Boolean(t),t.ogg=e.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/,""),t.mp3=e.canPlayType("audio/mpeg;").replace(/^no$/,""),t.opus=e.canPlayType('audio/ogg; codecs="opus"').replace(/^no$/,""),t.wav=e.canPlayType('audio/wav; codecs="1"').replace(/^no$/,""),t.m4a=(e.canPlayType("audio/x-m4a;")||e.canPlayType("audio/aac;")).replace(/^no$/,""))}catch(n){}return t}),/*!
	         ...
	         !*/
y.addTest("video",function(){var e=E("video"),t=!1;try{(t=!!e.canPlayType)&&(t=new Boolean(t),t.ogg=e.canPlayType('video/ogg; codecs="theora"').replace(/^no$/,""),t.h264=e.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/,""),t.webm=e.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/,""),t.vp9=e.canPlayType('video/webm; codecs="vp9"').replace(/^no$/,""),t.hls=e.canPlayType('application/x-mpegURL; codecs="avc1.42E01E"').replace(/^no$/,""))}catch(n){}return t});var b="Moz O ms Webkit",T=h._config.usePrefixes?b.split(" "):[];h._cssomPrefixes=T;var A=h._config.usePrefixes?b.toLowerCase().split(" "):[];h._domPrefixes=A;var R={elem:E("modernizr")};y._q.push(function(){delete R.elem});var O={style:R.elem.style};y._q.unshift(function(){delete O.style});var N=t.documentElement;h.testAllProps=g,h.testAllProps=v,/*!
	         {
	         "name": "CSS Transforms",
	         ...
	         !*/
y.addTest("csstransforms",function(){return-1===navigator.userAgent.indexOf("Android 2.")&&v("transform","scale(1)",!0)}),/*!
	         {
	         ...
	         !*/
y.addTest("csstransitions",v("transition","all",!0)),/*!
	         {
	         "name": "Web Workers",
	         "property": "webworkers",
	         "caniuse" : "webworkers",
	         ...
	         !*/
y.addTest("webworkers","Worker"in e);var x=h._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):[];h._prefixes=x;var L=h.testStyles=f;/*!
	         {
	         "name": "Touch Events",
...
y.addTest("touchevents",function(){var n;if("ontouchstart"in e||e.DocumentTouch&&t instanceof DocumentTouch)n=!0;else{var r=["@media (",x.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");L(r,function(e){n=9===e.offsetTop})}return n});var j=function(e){function n(t,n){var o;return t?(n&&"string"!=typeof n||(n=E(n||"div")),t="on"+t,o=t in n,!o&&r&&(n.setAttribute||(n=E("div")),n.setAttribute(t,""),o="function"==typeof n[t],n[t]!==e&&(n[t]=e),n.removeAttribute(t)),o):!1}var r=!("onblur"in t.documentElement);return n}(),k=h.hasEvent=j;/*!
	         ...
	         !*/
y.addTest("hashchange",function(){return k("hashchange",e)===!1?!1:t.documentMode===n||t.documentMode>7}),o(),delete h.addTest,delete h.addAsyncTest;for(var S=0;S<y._q.length;S++)y._q[S]();e.Modernizr=y}(window,document),e.support=window.Modernizr,t.info({message:"browser tested by Modernizr"}),window.app},n(203))}});
